...
import { PICKUPS, PICKUP_LINEUP, PRODUCTS } from './data';

// ============================================================
// PICKUPS — Landing page + individual product pages
// ============================================================

export function Pickups({ onNavigate }) {
  return (
...
export function PickupProduct({ id, onNavigate }) {
  const p = PICKUPS[id];
  if (!p) return null;
  return (
...
function PickupSpec({ p }) {
  ...
  const [tab, setTab] = useState(positions[0]);
