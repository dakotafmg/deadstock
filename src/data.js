...
export const PRODUCTS = {
  broadman: {
    ...
    price: "$7,000",
    finish: "Nitro",
    pickups: "Seymour Duncan Antiquity Tele",
    ...
    specs: {
      ...
      neck: [
        ...
        { k: "Frets",       v: "21 / Tall (0.079\" x 0.055\")" },
      ...
      electronics: [
        { k: "Neck PU",     v: "Seymour Duncan Antiquity Tele — Alnico 2, aged" },
        { k: "Bridge PU",   v: "Seymour Duncan Antiquity Tele — Alnico 5, aged" },
  ...
  monarch: {
    ...
    price: "Coming soon",
    finish: "Nitro",
    pickups: "Seymour Duncan Phat Cat (neck) / Antiquity Humbucker (bridge)",
    lede: "A premium offset with a Seymour Duncan Phat Cat in the neck and Antiquity Humbucker in the bridge, over a carved flamed maple top. Coming 2026.",
    swatches: [],
    images: [],
    story: {
      heading: "Where rock meets jazz — and stays.",
      problem: "The offset world is full of guitars that can't decide what they are. Too bright for jazz, too polite for rock, too refined to really push. We wanted one that could hold its own in both rooms without compromising either.",
      solution: "The Monarch pairs a carved flamed maple top with a Seymour Duncan Phat Cat P90 in the neck — fat midrange, that humbucker-sized snap — and an Antiquity Humbucker in the bridge for vintage PAF warmth that can still get loud. Bolt-on construction keeps it punchy. The carved top is not cosmetic.",
      pull: "This is the guitar for the player who refused to pick a lane.",
    },
    specs: {
      body: [
      ...
      electronics: [
        { k: "Neck PU",     v: "Seymour Duncan Phat Cat — Alnico 2, humbucker-sized P90" },
        { k: "Bridge PU",   v: "Seymour Duncan Antiquity Humbucker — Alnico 2, vintage PAF" },
...
export const SOURCES = [
  ...
  { what: "Seymour Duncan Pickups", who: "Seymour Duncan",      where: "Santa Barbara, CA", miles: "2,470 mi", cat: "ELECTRONICS" },
...
export const LINEUP = [
  ...
  },
  {
    ...
    serial: "DS-MON-001",
    price: "Coming soon",
    blurb: "A premium offset, in development. Carved top, bolt-on neck, Seymour Duncan Phat Cat neck and Antiquity Humbucker bridge.",
